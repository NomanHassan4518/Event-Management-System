      ...
      <div className="flex flex-col justify-center space-y-6 md:pl-10 text-center md:text-left">
        ...
        <ul className="flex flex-col sm:flex-row flex-wrap items-center justify-center md:justify-start gap-4 md:gap-6 text-gray-700 text-sm md:text-base">
          <li className="flex items-center gap-2">
            <span className="text-[#ce1446] text-lg md:text-xl"><MdOutlineEventSeat /></span>
            {event.seats}
          </li>
          <li className="flex items-center gap-2">
            <span className="text-[#ce1446] text-lg md:text-xl"><IoMegaphoneOutline /></span>
            {event.speakers}
          </li>
          <li className="flex items-center gap-2">
            <span className="text-[#ce1446] text-lg md:text-xl"><IoLocationOutline /></span>
            {event.location}
          </li>
        </ul>

        <div className="flex flex-col sm:flex-row gap-4 mt-8 md:mt-10 text-sm md:text-base justify-center md:justify-start">
          <button className="w-full sm:w-auto px-6 md:px-[45px] py-3 bg-[#ce1446] text-white rounded-lg shadow-lg hover:bg-pink-100 hover:text-[#ce1446] border-2 border-[#ce1446] transition">
            Book Now
          </button>
          <button className="w-full sm:w-auto px-6 md:px-[45px] py-3 bg-pink-100 text-[#ce1446] rounded-lg shadow-lg hover:bg-[#ce1446] hover:text-white border-2 border-[#ce1446] transition">
            View Details
          </button>
        </div>
      </div>
